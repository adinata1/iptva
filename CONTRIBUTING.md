...
5. Once the pull reuest has been accepted and merged, your changes will be available on our Content Delivery Network within 48 hours and accessible to everyone.L you provide is not shortened (for example using [s.id](https://home.s.id/en) or another URL shortener).
   - Please do NOT change or alter the channel URL that
